...
The pretrained models must be located under the directory ./pretrained_models
Due to memory constraints in the CMT submission form, only the models trained for the DVS128 Datasets are provided. However, all of them (DVS128, SL-Animals-DVS and ASL) will be public upon acceptance.
...
The datasets involved in the present work must be downloaded from their source and stored under the './datasets' path:
